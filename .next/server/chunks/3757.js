...
var urllib = __webpack_require__(57310);
...
var Cookies = __webpack_require__(66846);
var MAX_REDIRECTS = 5;
...
var fetch = __webpack_require__(75491);
/**
...
var SMTPConnection = __webpack_require__(56621);
var packageData = __webpack_require__(15743);
var wellknown = __webpack_require__(82359);
var shared = __webpack_require__(85384);
 ...
 */ function SMTPTransport(options) {
    ...
    this.options = assign(false, options, urlData, service && wellknown(service) // wellknown options
    );
    ...
    args.forEach(function(source) {
        Object.keys(source || {}).forEach(function(key) {
            if ([
                "tls",
                "auth"
            ].indexOf(key) >= 0 && source[key] && typeof source[key] === "object") {
...
var services = __webpack_require__(16033);
var normalized = {};
...
const MessageParser = __webpack_require__(77629);
...
var packageInfo = __webpack_require__(41727);
var EventEmitter = (__webpack_require__(82361).EventEmitter);
var util = __webpack_require__(73837);
...
var DataStream = __webpack_require__(77977);
var PassThrough = (__webpack_require__(12781).PassThrough);
var shared = __webpack_require__(85384);
module.exports = SMTPConnection;
/**
 ...
 */ SMTPConnection.prototype.login = function(authData, callback) {
    ...
    switch(authMethod){
        ...
        case "PLAIN":
            ...
            "\x00" + // skip authorization identity as it causes problems with some servers
            this._auth.user + "\x00" + this._auth.pass, "utf-8").toString("base64"));
            return;
        case "CRAM-MD5":
            this._currentAction = (function(str) {
                this._actionAUTH_CRAM_MD5(str, callback);
 ...
 */ SMTPConnection.prototype._onClose = function() {
    ...
    if ([
        this._actionGreeting,
        this.close
    ].indexOf(this._currentAction) < 0 && !this._destroyed) {
 ...
 */ SMTPConnection.prototype._actionAUTH_CRAM_MD5 = function(str, callback) {
    ...
    // Decode from base64
    var base64decoded = new Buffer(challengeString, "base64").toString("ascii"), hmac_md5 = crypto.createHmac("md5", this._auth.pass);
    hmac_md5.update(base64decoded);
    var hex_hmac = hmac_md5.digest("hex"), prepended = this._auth.user + " " + hex_hmac;
    this._currentAction = (function(str) {
        this._actionAUTH_CRAM_MD5_PASS(str, callback);
    }).bind(this);
...
module.exports = JSON.parse('{"name":"nodemailer-smtp-transport","version":"2.4.2","description":"SMTP transport for Nodemailer","main":"lib/smtp-transport.js","scripts":{"test":"grunt"},"repository":{"type":"git","url":"git://github.com/andris9/nodemailer-smtp-transport.git"},"keywords":["SMTP","Nodemailer"],"author":"Andris Reinman","license":"MIT","bugs":{"url":"https://github.com/andris9/nodemailer-smtp-transport/issues"},"homepage":"http://github.com/andris9/nodemailer-smtp-transport","dependencies":{"nodemailer-shared":"1.0.4","nodemailer-wellknown":"0.1.8","smtp-connection":"2.3.2"},"devDependencies":{"chai":"^3.5.0","grunt":"^1.0.1","grunt-eslint":"^18.0.0","grunt-mocha-test":"^0.12.7","mocha":"^2.4.5","smtp-server":"^1.9.0"}}');
...
module.exports = JSON.parse('{"name":"smtp-connection","version":"2.3.2","description":"Connect to SMTP servers","main":"lib/smtp-connection.js","directories":{"test":"test"},"scripts":{"test":"grunt"},"repository":{"type":"git","url":"git://github.com/andris9/smtp-connection.git"},"keywords":["SMTP"],"author":"Andris Reinman","license":"MIT","bugs":{"url":"https://github.com/andris9/smtp-connection/issues"},"homepage":"https://github.com/andris9/smtp-connection","devDependencies":{"chai":"^3.5.0","grunt":"^1.0.1","grunt-eslint":"^18.0.0","grunt-mocha-test":"^0.12.7","mocha":"^2.4.5","proxy-test-server":"^1.0.0","sinon":"^1.17.3","smtp-server":"^1.9.0","xoauth2":"^1.1.0"},"dependencies":{"nodemailer-shared":"1.0.4"}}');
