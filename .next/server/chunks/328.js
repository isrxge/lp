...
const BlogCard = ({ data })=>{
    const curlanguage = (0,react_redux__WEBPACK_IMPORTED_MODULE_6__.useSelector)((rootState)=>(0,_feature_changeLanguage_changeLanguageSlice__WEBPACK_IMPORTED_MODULE_7__/* .language */ .dK)(rootState));
