...
async function POST(req) {
    ...
    try {
        ...
        await models_user/* default */.Z.create({
            email,
            password
        });
...
async function GET() {
    try {
        await (0,mongodb/* default */.Z)();
        const user = await models_user/* default */.Z.find({});
        return next_response/* default */.Z.json({
            user
        });
    } catch (error) {
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fuser%2Froute&name=app%2Fapi%2Fuser%2Froute&pagePath=private-next-app-dir%2Fapi%2Fuser%2Froute.js&appDir=G%3A%5Cvercel%5Clpc_landingpage%5Csrc%5Capp&appPaths=%2Fapi%2Fuser%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
    ...
    const options = {"definition":{"kind":"APP_ROUTE","page":"/api/user/route","pathname":"/api/user","filename":"route","bundlePath":"app/api/user/route"},"resolvedPagePath":"G:\\vercel\\lpc_landingpage\\src\\app\\api\\user\\route.js","nextConfigOutput":""}
...
var __webpack_exports__ = __webpack_require__.X(0, [2564,2778], () => (__webpack_exec__(32087)));
